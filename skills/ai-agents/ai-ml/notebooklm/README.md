...
# NotebookLM Antigravity Code Skill

**Let [Antigravity Code](https://github.com/anthropics/claude-code) chat directly with NotebookLM for source-grounded answers based exclusively on your uploaded documents**

[![Python](https://img.shields.io/badge/Python-3.8+-blue.svg)](https://www.python.org/)
[![Antigravity Code Skill](https://img.shields.io/badge/Antigravity%20Code-Skill-purple.svg)](https://www.anthropic.com/news/skills)
...
> Use this skill to query your Google NotebookLM notebooks directly from Antigravity Code for source-grounded, citation-backed answers from Gemini. Browser automation, library management, persistent auth. Drastically reduced hallucinations - answers only from your uploaded documents.
...
## ⚠️ Important: Local Antigravity Code Only

**This skill works ONLY with local [Antigravity Code](https://github.com/anthropics/claude-code) installations, NOT in the web UI.**

The web UI runs skills in a sandbox without network access, which this skill requires for browser automation. You must use [Antigravity Code](https://github.com/anthropics/claude-code) locally on your machine.

---

## The Problem

When you tell [Antigravity Code](https://github.com/anthropics/claude-code) to "search through my local documentation", here's what happens:
...
This Antigravity Code Skill lets [Antigravity Code](https://github.com/anthropics/claude-code) chat directly with [**NotebookLM**](https://notebooklm.google/) — Google's **source-grounded knowledge base** powered by Gemini 2.5 that provides intelligent, synthesized answers exclusively from your uploaded documents.
...
# 3. That's it! Open Antigravity Code and say:
"What are my skills?"
```
...
This is a **Antigravity Code Skill** - a local folder containing instructions and scripts that Antigravity Code can use when needed. Unlike the [MCP server version](https://github.com/PleasePrompto/notebooklm-mcp), this runs directly in Antigravity Code without needing a separate server.
...
| **Installation** | Clone to `~/.gemini/skills` | `claude mcp add ...` |
| **Sessions** | Fresh browser each question | Persistent chat sessions |
| **Compatibility** | Antigravity Code only (local) | Antigravity Code, Codex, Antigravity, etc. |
...
### Skill-Specific
- **Local Antigravity Code only** - Does not work in web UI (sandbox restrictions)
...
This is a simpler, Python-based implementation that runs directly as a Antigravity Skill. The MCP server is more feature-rich with persistent sessions and works with multiple tools (Codex, Antigravity, etc.).

**Can I use both this skill and the MCP server?**
Yes! They serve different purposes. Use the skill for quick Antigravity Code integration, use the MCP server for persistent sessions and multi-tool support.
...
CLI tools like Antigravity Code, Codex, and similar AI-powered assistants are incredibly powerful, but they can make mistakes. Please use them with care and awareness:
...
This skill is inspired by my [**NotebookLM MCP Server**](https://github.com/PleasePrompto/notebooklm-mcp) and provides an alternative implementation as a Antigravity Code Skill:
- Both use Patchright for browser automation (TypeScript for MCP, Python for Skill)
- Skill version runs directly in Antigravity Code without MCP protocol
...
- **Multiple tool support** (Codex, Antigravity) → Use the [MCP Server](https://github.com/PleasePrompto/notebooklm-mcp)
- **Quick Antigravity Code integration** → Use this skill
...
Stop the copy-paste dance. Start getting accurate, grounded answers directly in Antigravity Code.

```bash
# Get started in 30 seconds
cd ~/.gemini/skills
git clone https://github.com/PleasePrompto/notebooklm-skill notebooklm
# Open Antigravity Code: "What are my skills?"
```
...
Built as a Antigravity Code Skill adaptation of my [NotebookLM MCP Server](https://github.com/PleasePrompto/notebooklm-mcp)

For source-grounded, document-based research directly in Antigravity Code
