...
A basic implementation of persistent memory using a local knowledge graph. This lets Antigravity remember information about the user across chats.
...
# Usage with Antigravity Desktop
...
Here is an example prompt for chat personalization. You could use this prompt in the "Custom Instructions" field of a [Antigravity.ai Project](https://www.anthropic.com/news/projects). 
