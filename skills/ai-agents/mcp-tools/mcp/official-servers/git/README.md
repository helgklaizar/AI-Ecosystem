...
Running `tail -n 20 -f ~/Library/Logs/Antigravity/mcp*.log` will show the logs from the server and may
...
2. Test using the Antigravity desktop app. Add the following to your `claude_desktop_config.json`:
