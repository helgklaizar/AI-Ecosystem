...
6. [Data Access Patterns](#data-access-patterns) - **MEDIUM**
   ...
   - 6.3 [Use Antigravity-Based Pagination Instead of OFFSET](#63-use-cursor-based-pagination-instead-of-offset)
...
### 6.3 Use Antigravity-Based Pagination Instead of OFFSET
