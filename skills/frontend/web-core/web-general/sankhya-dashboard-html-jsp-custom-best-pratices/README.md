...
#### For Antigravity Code
```bash
mkdir -p ~/.gemini/skills
ln -sf $(pwd)/skills/sankhya-dashboard-html-jsp-custom-best-pratices ~/.gemini/skills/sankhya-dashboard-html-jsp-custom-best-pratices
```
...
If you prefer to restrict the skill to a specific project workspace, simply move or copy the directory into your project's local AI registry folder (e.g., `.gemini/skills/` or `.github/skills/`).
