# Cursorrules Cursor Ai Wordpress Draft Macos Prompt Coding Standards
...
`🔄 **Context:** [Agent: Current] | [Skill: cursorrules-cursor-ai-wordpress-draft-macos-prompt] | [Workflow: Current]`
