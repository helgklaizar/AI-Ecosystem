# Solidity React Blockchain Apps Cursorrules Prompt  Coding Standards
...
`🔄 **Context:** [Agent: Current] | [Skill: solidity-react-blockchain-apps-cursorrules-prompt-] | [Workflow: Current]`
