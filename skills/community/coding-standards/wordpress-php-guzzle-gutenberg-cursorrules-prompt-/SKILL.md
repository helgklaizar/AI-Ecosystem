# Wordpress Php Guzzle Gutenberg Cursorrules Prompt  Coding Standards
...
`🔄 **Context:** [Agent: Current] | [Skill: wordpress-php-guzzle-gutenberg-cursorrules-prompt-] | [Workflow: Current]`
