# Cursor Ai React Typescript Shadcn Ui Cursorrules P Coding Standards
...
`🔄 **Context:** [Agent: Current] | [Skill: cursor-ai-react-typescript-shadcn-ui-cursorrules-p] | [Workflow: Current]`
