...
### For Antigravity Code (Desktop/CLI)

#### Project-Level Installation
```bash
# Copy skill folder to project
cp -r app-store-optimization /path/to/your/project/.gemini/skills/
...
ls ~/.gemini/skills/app-store-optimization/
...
This skill is provided as-is for use with Antigravity Code and Antigravity Apps. Customize and extend as needed for your specific use cases.
